...
import com.truongthong.map4d.adapter.RestaurantAdapter
...
class RestaurantFragment : Fragment(), OnMapReadyCallback,
    RestaurantAdapter.OnMapItemClickListener {

    private var map4D: Map4D? = null
    private var nearbyAdapter = RestaurantAdapter(arrayListOf(), this)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        nearbyPlaceViewModel.getNearby("16.0721,108.2243", 8000, "nha hang")
    ...
    private fun setupRecyclerView() {
        nearbyAdapter = RestaurantAdapter(arrayListOf(), this)
        rv_listNearby.apply {
