...
class RouteLocationFragment : Fragment(), OnMapReadyCallback {
    ...
    private fun buttonChooseVehicle() {
        ...
        cardView_Car.setOnClickListener {
            mapViewModel.getRouteLocation(edt_origin.text.toString(), edt_destination.text.toString(), "car")
        ...
        cardView_Motor.setOnClickListener {
            mapViewModel.getRouteLocation(edt_origin.text.toString(), edt_destination.text.toString(), "motorcycle")
        ...
        cardView_Walk.setOnClickListener {
            mapViewModel.getRouteLocation(edt_origin.text.toString(), edt_destination.text.toString(), "foot")
    ...
    private fun polylineRoute() {
        ...
        mapViewModel.routeLocation.observe(viewLifecycleOwner, {
            it.body()?.result?.routes?.forEach {
                it.legs.forEach {
                    it.steps.forEach {
                        latLngList.add(MFLocationCoordinate(it.startLocation.lat, it.startLocation.lng))
